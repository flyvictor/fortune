...
Fortune.prototype.resource = function(name, schema, options, schemaCallback) {
  ...
  this._resources[name] = { name: name, route: _this.inflect.pluralize(name), schema: schema, modelOptions: modelOptions, hooksOptions: hooksOptions, policy: policyOptions};
