...
Fortune.prototype._init = function (options) {
  ...
  // Create a swagger module instance.
...
Fortune.prototype._exposeResourceDefinitions = function() {
  ...
  this.router.get(resourceRoute, function(req,res){
    if (_this._ready){
      var metadata = _this.swagger.generateSwaggerMetadata(_this._resources, req);
      res.write(JSON.stringify(metadata ? metadata : {resources: _this.resources()}));
      res.end();
    }else{
      res.writeHead(503);
      res.end();
