          ...
          .end(function (err, res) {
            ...
            request(baseUrl)
              ...
              .end(function (err, res) {
                ...
                const addresses = res.body.people[0].links.addresses;
      ...
      beforeEach(function (done) {
        request(baseUrl)
            ...
            JSON.stringify([
              {
                ...
                value: [ids.people[1], ids.people[2]],
              },
              {
                op: 'replace',
          ...
          .end(function (err, res) {
            ...
            body.people[0].links.lovers.should.eql([
              ids.people[1],
              ids.people[2],
            ]);
            body.people[0].links.soulmate.should.eql(ids.people[1]);
            body.people[0].links.addresses.should.eql([
              ids.addresses[0],
              ids.addresses[1],
            ]);
            done();
      ...
      it('should work with many-to-one refs', function (done) {
        request(baseUrl)
          ...
          .end(function (err) {
            should.not.exist(err);
            request(baseUrl)
              .get(`/addresses/${ids.addresses[0]},${ids.addresses[1]}`)
              .end(function (err, res) {
                should.not.exist(err);
                const body = JSON.parse(res.text);
      ...
      it('should work fine with many-to-many refs', function (done) {
        request(baseUrl)
          ...
          .end(function (err) {
            should.not.exist(err);
            request(baseUrl)
              .get(`/people/${ids.people[1]},${ids.people[2]}`)
              .end(function (err, res) {
                should.not.exist(err);
                const body = JSON.parse(res.text);
