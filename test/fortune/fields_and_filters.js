  ...
  describe('fields and filters', function () {
      ...
      it('should support replacing just one of the values', function (done) {
        request(baseUrl)
          ...
          .end(function (error, response) {
            ...
            JSON.parse(response.text).people[0].nested.should.eql({
              field1: 'value1',
            });
            request(baseUrl)
              .patch(`/people/${ids.people[0]}`)
    ...
    describe('sparse fieldsets', function () {
      ...
      it('should return specific fields for documents', function (done) {
        request(baseUrl)
          .get(`/people/${ids.people[0]}?fields=name,email,pets`)
      ...
      it('should return specific fields for linked document of a collection', function (done) {
        request(baseUrl)
          .get('/people?include=pets&fields[pets]=name')
          .expect('Content-Type', /json/)
          .expect(200)
      ...
      it('should return specific fields for linked document of single doc', function (done) {
        request(baseUrl)
          .get(`/people/${ids.people[0]}?include=pets&fields[pets]=name`)
          .expect('Content-Type', /json/)
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
    ...
    describe('filters', function () {
      ...
      it('should allow top-level resource filtering based on a numeric value', function (done) {
        request(baseUrl)
          .get('/people?filter[appearances]=1934')
          .expect('Content-Type', /json/)
          .expect(200)
          .end(function (error, response) {
            should.not.exist(error);
      ...
      it('should allow resource sub-document filtering based on a numeric value', function (done) {
        request(baseUrl)
          .get('/cars?filter[additionalDetails.seats]=2')
          .end(function (err, res) {
            const body = JSON.parse(res.text);
      ...
      it('should allow top-level resource filtering based on Date string', function (done) {
        request(baseUrl)
          .get('/people?filter[birthday][gte]=1995-01-01')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should return correct error if date is not recognized', function (done) {
        request(baseUrl)
          .get('/people?filter[birthday]=time of big bang')
          .expect(400)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
            body.should.eql({
              ...
              detail:
                'CastError: Cast to date failed for value "time of big bang" (type string) at path "birthday" for model "person"',
            });
            done();
          });
      });
      it.skip("should allow resource filtering based on wordy dates, like 'today', 'yesterday', 'tomorrow', etc", function (done) {
        ...
        request(baseUrl)
          .get('/people?filter[birthday]=yesterday')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it.skip("should allow resource filtering based on wordy dates, like 'today', 'yesterday', 'tomorrow', etc used along with $gte, $lte", function (done) {
        clock = sinon.useFakeTimers(new Date(2000, 00, 02).getTime());
        request(baseUrl)
          .get('/people?filter[birthday][gte]=yesterday')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should return correct error if date is not recognized inside of complex filter with $gte, $lte', function (done) {
        request(baseUrl)
          .get('/people?filter[birthday][gte]=time of big bang')
          .expect(400)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should correctly accept $exists: true', function (done) {
        request(baseUrl)
          .get('/people?filter[birthday][$exists]=tRue')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should correctly accept $exists: false', function (done) {
        request(baseUrl)
          .get('/people?filter[birthday][$exists]=faLse')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should be possible to filter related resources by ObjectId', function (done) {
        ...
        request(baseUrl)
          ...
          .end(function (err) {
            should.not.exist(err);
            request(baseUrl)
              .get(`/people?filter[pets]=${ids.pets[0]}`)
              .expect(200)
              .end(function (err, res) {
                should.not.exist(err);
      ...
      it('should support filtering by id for one-to-one relationships', function (done) {
        new Promise(function (resolve) {
          ...
          request(baseUrl)
            .get(`/people?filter[soulmate]=${ids.people[1]}`)
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
              const body = JSON.parse(res.text);
      ...
      it('should support regex query', function (done) {
        request(baseUrl)
          .get('/people?filter[email][regex]=Bert@&filter[email][options]=i')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should support `in` query', function (done) {
        new Promise(function (resolve) {
          ...
          .then(function () {
            request(baseUrl)
              .get(
                `/people?filter[houses][in]=${ids.houses[0]},${ids.houses[1]}`,
              )
              .expect(200)
              .end(function (err, res) {
                should.not.exist(err);
      ...
      it('should support $in query against one-to-one refs', function (done) {
        new Promise(function (resolve) {
          request(baseUrl)
            .patch('/people/robert@mailbert.com')
            .set('content-type', 'application/json')
            .send(
              JSON.stringify([
                {
          ...
          request(baseUrl)
            .get(
              '/people?filter[soulmate][$in]=robert@mailbert.com&filter[soulmate][$in]=dilbert@mailbert.com',
            )
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
      ...
      it('should support $in query against many-to-many refs', function (done) {
        new Promise(function (resolve) {
          ...
          request(baseUrl)
            .get(
              '/people?filter[lovers][$in]=robert@mailbert.com&filter[lovers][$in]=dilbert@mailbert.com',
            )
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
      ...
      it('should support $in query against external refs values', function (done) {
        new Promise(function (resolve) {
          ...
          request(baseUrl)
            .get('/cars?filter[MOT][$in]=Pimp-my-ride')
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
              const body = JSON.parse(res.text);
      ...
      it('should be able to run $in query against nested fields', function (done) {
        request(baseUrl)
          .get('/cars?filter[additionalDetails.seats][in]=2')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should be able to run in query against links', function (done) {
        new Promise(function (resolve) {
          ...
          request(baseUrl)
            .get(
              `/people?filter[soulmate][in]=${ids.people[0]},${ids.people[1]}`,
            )
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
      ...
      it('should support special mongo $prefixed queries against external resources', function (done) {
        new Promise(function (resolve) {
          ...
          request(baseUrl)
            .get('/cars?filter[MOT][$exists]=true')
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
              const body = JSON.parse(res.text);
      ...
      it('should support or query', function (done) {
        request(baseUrl)
          .get(
            '/people?filter[or][0][name]=Dilbert&filter[or][1][email]=robert@mailbert.com&sort=name',
          )
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
      ...
      describe('filtering by related objects fields', function () {
        ...
        it('should be able to filter by related resource fields', function (done) {
          request(baseUrl)
            .get(`/cars?filter[owner][soulmate]=${ids.people[0]}`)
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
              const body = JSON.parse(res.text);
        ...
        it('should be able to filter by two and more parameters', function (done) {
          new Promise(function (resolve) {
            request(baseUrl)
              .get(
                `/pets?filter[owner][name][regex]=ally&filter[owner][soulmate]=${ids.people[0]}`,
              )
              .expect(200)
              .end(function (err, res) {
                should.not.exist(err);
            ...
            request(baseUrl)
              .get('/pets?filter[owner][name][regex]=ally')
              .expect(200)
              .end(function (err, res) {
                should.not.exist(err);
                const body = JSON.parse(res.text);
        ...
        it('should be able to apply OR filter to related resources', function (done) {
          request(baseUrl)
            .get(
              `/cars?filter[or][0][owner][soulmate]=${ids.people[0]}&filter[or][1][id]=${ids.cars[0]}`,
            )
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
              ...
              const one = _.find(body.cars, { id: ids.cars[0] });
              const two = _.find(body.cars, { id: ids.cars[1] });
              should.exist(one);
              should.exist(two);
              done();
            });
        ...
        it('should be able to apply AND filter to related resources', function (done) {
          request(baseUrl)
            .get(
              `/pets?filter[and][0][owner][soulmate][email]=${ids.people[0]}&filter[and][1][owner][email]=${ids.people[1]}`,
            )
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
        ...
        describe('should rewrite id to resource PK for', function () {
          it('$and filters', function (done) {
            request(baseUrl)
              .get(`/people?filter[$and][0][id]=${ids.people[0]}`)
              .expect(200)
              .end(function (err, res) {
                should.not.exist(err);
                const body = JSON.parse(res.text);
          ...
          it('$or filters', function (done) {
            request(baseUrl)
              .get(`/people?filter[$or][0][id]=${ids.people[0]}`)
              .expect(200)
              .end(function (err, res) {
                should.not.exist(err);
                const body = JSON.parse(res.text);
        ...
        it('should be able to nest OR and AND filters', function (done) {
          request(baseUrl)
            .get(`/houses?filter[or][0][and][0][owners][in]=${ids.people[0]}`)
            .expect(200)
            .end(function (err, res) {
              should.not.exist(err);
              const body = JSON.parse(res.text);
    ...
    describe('paging', function () {
      it('should be possible to get page 1', function (done) {
        request(baseUrl)
          .get('/people?sort=name&page=1&pageSize=2')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should be possible to get page 2', function (done) {
        request(baseUrl)
          .get('/people?sort=name&page=2&pageSize=2')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
    ...
    describe('counting', function () {
      ...
      it('should return total count in if meta requested', function (done) {
        request(baseUrl)
          .get('/people?sort=name&page=2&pageSize=2&includeMeta=true')
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
            const body = JSON.parse(res.text);
      ...
      it('should return filter total count in if meta requested and any filter used', function (done) {
        request(baseUrl)
          .get(
            '/people?sort=name&page=2&pageSize=2&includeMeta=true&filter[birthday][gte]=1995-01-01',
          )
          .expect(200)
          .end(function (err, res) {
            should.not.exist(err);
      ...
      it('should restrict total count to the fortune extension query', function (done) {
        request(baseUrl)
          .get('/people?filter[name]=Wally&includeMeta=true')
